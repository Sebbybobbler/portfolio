      ...
      <div className="picAndText reverse ">
        <div className="homeBioBlack">
          <p>
            ...
            full-stack bootcamp. My original background is in theoretical
            physics academia, allowing me to bring a unique and inquisitive
            approach to software development. I am veraciously curious and love
            learning.
          </p>
        </div>
      ...
      <div className="picAndText  reverse">
        <div className="homeBioBlack">
          <p>
            ...
            culminated in presentations to industry professionals. You can find
            out more about these projects{" "}
      ...
      <div className="picAndText ">
        <div className="homeBioGrey">
          <p>
            ...
            bootcamp I attended Q&A style talks from industry experts, not only
            in web-development but also in surrounding fields (project
            management, design etc). I also enjoy attending local Brighton tech
            events, such as Async and TechJumpStart. This exposure has given me
            an insight into the real world of development and has only made me
            more excited to jump into that first role!
          </p>
        </div>
      ...
      <div className="picAndText   reverse">
        <div className="homeBioBlack">
          <p>
            ...
            of teamwork and pair-programming and AGILE methodology. Honestly,
            this was frightening at first, however, it is now one of my
            favourite aspects of development. Working closely with others has
            allowed me to grow, share ideas, tech tips and improve via code
            reviews. Group work has also given me the ability to thrive within
            the workplace, contributing and benefiting from shared discussion
            and knowledge.
          </p>
        </div>
      ...
      <div className="picAndText ">
        <div className="homeBioGrey">
          <p>
            ...
            logical, mathematical and social problem solving skills. Whilst, the
            bootcamp has nourished this existing skillset I have also developed
            strong technical and cross-functional skills allowing me to slot
            into a developer role and quickly become effective.
          </p>
        </div>
      </div>
      <div className="picAndText  reverse ">
